...
function App() {
  ...
  const [departureDate, setDepartureDate] = useState(formatDate(new Date(Date.now() + DAY_IN_MILLISECONDS))); // tomorrow
  ...
  const submitForm = (event) => {
    ...
    alert(`You have booked a round-trip flight, departing on ${departureDate} and returning on ${returnDate}`)
  }
